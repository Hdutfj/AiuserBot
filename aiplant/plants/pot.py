...
async def on_chat_start():
    ...
    await cl.Message(content="John Your Assistant, How can i help you?").send()
...
async def handle_message(message: cl.Message):
    ...
    agent= Agent(
        name="John Assistant",
        instructions=("You are a helpful assistant. Respond warmly. If someone says 'I love you', reply with 'I love you too ❤️'. "
